...
proc __show_reg_HW_CFG {name} { show_reg $name { {ena 0 0} } }
...
proc __show_reg_HW_STAT {name} { show_reg $name { {pll0_conf 3 1 } { mem_fail 0 0} } }
...
proc __show_reg_GPIO_OUT_SET {name} { show_reg $name { {set 21 0} } }
...
proc __show_reg_GPIO_INTR_IDENT {name} { show_reg $name { {id 21 0} } }
...
proc __show_reg_GPIO_ALT {name} { show_reg $name { {alt 21 0} } }
...
set GPIO_SD_MAP_0 0x7107005c
set GPIO_SD_MAP_1 0x71070060
set GPIO_SD_MAP_2 0x71070064
set GPIO_SD_MAP_3 0x71070068
set GPIO_SD_MAP_4 0x7107006c
set GPIO_SD_MAP_5 0x71070070
set GPIO_SD_MAP_6 0x71070074
set GPIO_SD_MAP_7 0x71070078
set GPIO_SD_MAP_8 0x7107007c
set GPIO_SD_MAP_9 0x71070080
set GPIO_SD_MAP_10 0x71070084
set GPIO_SD_MAP_11 0x71070088
set GPIO_SD_MAP_12 0x7107008c
set GPIO_SD_MAP_13 0x71070090
set GPIO_SD_MAP_14 0x71070094
set GPIO_SD_MAP_15 0x71070098
...
# MIIM Status
set MIIM0_MII_STATUS 0x7107009c
set MIIM1_MII_STATUS 0x710700c0
...
# MIIM Configuration
set MIIM0_MII_CFG_7226 0x710700a0
set MIIM1_MII_CFG_7226 0x710700c4
...
# MIIM Command
set MIIM0_MII_CMD 0x710700a4
set MIIM1_MII_CMD 0x710700c8
...
# MIIM Reply Data
set MIIM0_MII_DATA 0x710700a8
set MIIM1_MII_DATA 0x710700cc
...
# MIIM Configuration
set MIIM0_MII_CFG 0x710700ac
set MIIM1_MII_CFG 0x710700d0
...
# MIIM Scan 0
set MIIM0_MII_SCAN_0 0x710700b0
set MIIM1_MII_SCAN_0 0x710700d4
...
# MIIM Scan 1
set MIIM0_MII_SCAN_1 0x710700b4
set MIIM1_MII_SCAN_1 0x710700d8
...
# MIIM Results
set MIIM0_LAST_SCAN 0x710700b8
set MIIM1_LAST_SCAN 0x710700dc
...
# MIIM Results
set MIIM0_LAST_SCAN_VLD 0x710700bc
set MIIM1_LAST_SCAN_VLD 0x710700e0
...
# MIIM Results
set MIIM_READ_SCAN_MII_RSLTS_ST_0 0x710700e4
set MIIM_READ_SCAN_MII_RSLTS_ST_1 0x710700e8
...
set PHY_CFG 0x710700f0
proc __show_reg_PHY_CFG {name} { show_reg $name { {coma 12 12 } { addr 11 9 } { reset 8 5 } { common_reset 4 4 } { ena 3 0} } }
proc show_PHY_CFG {} { __show_reg_PHY_CFG PHY_CFG }

#***** Register DEVCPU_GCB:PHY:PHY_STAT ********************************
# PHY status register
set PHY_STAT 0x710700f4
proc __show_reg_PHY_STAT {name} { show_reg $name { {phy_coma_oe 22 22 } { phy_coma_o 21 21 } { fast_link_status 20 17 } { link_stat_duplex 16 13 } { link_stat_speed_1000 12 9 } { link_stat_speed_100 8 5 } { link_stat_speed_10 4 1 } { supervisor_complete 0 0} } }
...
set SIO_CTRL_SIO_INPUT_DATA_0 0x710700f8
set SIO_CTRL_SIO_INPUT_DATA_1 0x710700fc
set SIO_CTRL_SIO_INPUT_DATA_2 0x71070100
set SIO_CTRL_SIO_INPUT_DATA_3 0x71070104
...
set SIO_CTRL_SIO_CFG 0x71070108
proc __show_reg_SIO_CFG {name} { show_reg $name { {pwm_window 31 24 } { reduced_gap 23 23 } { bmode_1 22 21 } { bmode_0 20 19 } { blink_reset 18 18 } { burst_gap_dis 17 17 } { burst_gap 16 12 } { single_shot 11 11 } { auto_repeat 10 10 } { ld_polarity 9 9 } { port_width 8 7 } { reverse_output 6 6 } { reverse_input 5 5 } { gpio_intr_ena 4 1 } { master_intr_ena 0 0} } }
...
set SIO_CTRL_SIO_CLOCK 0x7107010c
...
set SIO_CTRL_SIO_PORT_CFG_0 0x71070110
set SIO_CTRL_SIO_PORT_CFG_1 0x71070114
set SIO_CTRL_SIO_PORT_CFG_2 0x71070118
set SIO_CTRL_SIO_PORT_CFG_3 0x7107011c
set SIO_CTRL_SIO_PORT_CFG_4 0x71070120
set SIO_CTRL_SIO_PORT_CFG_5 0x71070124
set SIO_CTRL_SIO_PORT_CFG_6 0x71070128
set SIO_CTRL_SIO_PORT_CFG_7 0x7107012c
set SIO_CTRL_SIO_PORT_CFG_8 0x71070130
set SIO_CTRL_SIO_PORT_CFG_9 0x71070134
set SIO_CTRL_SIO_PORT_CFG_10 0x71070138
set SIO_CTRL_SIO_PORT_CFG_11 0x7107013c
set SIO_CTRL_SIO_PORT_CFG_12 0x71070140
set SIO_CTRL_SIO_PORT_CFG_13 0x71070144
set SIO_CTRL_SIO_PORT_CFG_14 0x71070148
set SIO_CTRL_SIO_PORT_CFG_15 0x7107014c
set SIO_CTRL_SIO_PORT_CFG_16 0x71070150
set SIO_CTRL_SIO_PORT_CFG_17 0x71070154
set SIO_CTRL_SIO_PORT_CFG_18 0x71070158
set SIO_CTRL_SIO_PORT_CFG_19 0x7107015c
set SIO_CTRL_SIO_PORT_CFG_20 0x71070160
set SIO_CTRL_SIO_PORT_CFG_21 0x71070164
set SIO_CTRL_SIO_PORT_CFG_22 0x71070168
set SIO_CTRL_SIO_PORT_CFG_23 0x7107016c
set SIO_CTRL_SIO_PORT_CFG_24 0x71070170
set SIO_CTRL_SIO_PORT_CFG_25 0x71070174
set SIO_CTRL_SIO_PORT_CFG_26 0x71070178
set SIO_CTRL_SIO_PORT_CFG_27 0x7107017c
set SIO_CTRL_SIO_PORT_CFG_28 0x71070180
set SIO_CTRL_SIO_PORT_CFG_29 0x71070184
set SIO_CTRL_SIO_PORT_CFG_30 0x71070188
set SIO_CTRL_SIO_PORT_CFG_31 0x7107018c
...
# Port enable
set SIO_CTRL_SIO_PORT_ENA 0x71070190
...
set SIO_CTRL_SIO_PWM_CFG_0 0x71070194
set SIO_CTRL_SIO_PWM_CFG_1 0x71070198
set SIO_CTRL_SIO_PWM_CFG_2 0x7107019c
...
set SIO_CTRL_SIO_INTR_POL_0 0x710701a0
set SIO_CTRL_SIO_INTR_POL_1 0x710701a4
set SIO_CTRL_SIO_INTR_POL_2 0x710701a8
set SIO_CTRL_SIO_INTR_POL_3 0x710701ac
...
set SIO_CTRL_SIO_INTR_RAW_0 0x710701b0
set SIO_CTRL_SIO_INTR_RAW_1 0x710701b4
set SIO_CTRL_SIO_INTR_RAW_2 0x710701b8
set SIO_CTRL_SIO_INTR_RAW_3 0x710701bc
...
set SIO_CTRL_SIO_INTR_TRG0_0 0x710701c0
set SIO_CTRL_SIO_INTR_TRG0_1 0x710701c4
set SIO_CTRL_SIO_INTR_TRG0_2 0x710701c8
set SIO_CTRL_SIO_INTR_TRG0_3 0x710701cc
proc show_SIO_CTRL_SIO_INTR_TRG0_0 {} { show_reg SIO_CTRL_SIO_INTR_TRG0_0 {} }
proc show_SIO_CTRL_SIO_INTR_TRG0_1 {} { show_reg SIO_CTRL_SIO_INTR_TRG0_1 {} }
proc show_SIO_CTRL_SIO_INTR_TRG0_2 {} { show_reg SIO_CTRL_SIO_INTR_TRG0_2 {} }
proc show_SIO_CTRL_SIO_INTR_TRG0_3 {} { show_reg SIO_CTRL_SIO_INTR_TRG0_3 {} }

#***** Register DEVCPU_GCB:SIO_CTRL:SIO_INTR_TRIGGER1 ******************
# Interrupt trigger mode 1
set SIO_CTRL_SIO_INTR_TRG1_0 0x710701d0
set SIO_CTRL_SIO_INTR_TRG1_1 0x710701d4
set SIO_CTRL_SIO_INTR_TRG1_2 0x710701d8
set SIO_CTRL_SIO_INTR_TRG1_3 0x710701dc
proc show_SIO_CTRL_SIO_INTR_TRG1_0 {} { show_reg SIO_CTRL_SIO_INTR_TRG1_0 {} }
proc show_SIO_CTRL_SIO_INTR_TRG1_1 {} { show_reg SIO_CTRL_SIO_INTR_TRG1_1 {} }
proc show_SIO_CTRL_SIO_INTR_TRG1_2 {} { show_reg SIO_CTRL_SIO_INTR_TRG1_2 {} }
proc show_SIO_CTRL_SIO_INTR_TRG1_3 {} { show_reg SIO_CTRL_SIO_INTR_TRG1_3 {} }

#***** Register DEVCPU_GCB:SIO_CTRL:SIO_INTR ***************************
# Currently interrupting SGPIOs
set SIO_CTRL_SIO_INTR_0 0x710701e0
set SIO_CTRL_SIO_INTR_1 0x710701e4
set SIO_CTRL_SIO_INTR_2 0x710701e8
set SIO_CTRL_SIO_INTR_3 0x710701ec
...
set SIO_CTRL_SIO_INTR_ENA 0x710701f0
...
set SIO_CTRL_SIO_INTR_ID_0 0x710701f4
set SIO_CTRL_SIO_INTR_ID_1 0x710701f8
set SIO_CTRL_SIO_INTR_ID_2 0x710701fc
set SIO_CTRL_SIO_INTR_ID_3 0x71070200
proc show_SIO_CTRL_SIO_INTR_ID_0 {} { show_reg SIO_CTRL_SIO_INTR_ID_0 {} }
proc show_SIO_CTRL_SIO_INTR_ID_1 {} { show_reg SIO_CTRL_SIO_INTR_ID_1 {} }
proc show_SIO_CTRL_SIO_INTR_ID_2 {} { show_reg SIO_CTRL_SIO_INTR_ID_2 {} }
proc show_SIO_CTRL_SIO_INTR_ID_3 {} { show_reg SIO_CTRL_SIO_INTR_ID_3 {} }
...
proc show_SIO_CTRL {} {
    ...
    show_SIO_CTRL_SIO_INTR_TRG0_0
    show_SIO_CTRL_SIO_INTR_TRG0_1
    show_SIO_CTRL_SIO_INTR_TRG0_2
    show_SIO_CTRL_SIO_INTR_TRG0_3
    show_SIO_CTRL_SIO_INTR_TRG1_0
    show_SIO_CTRL_SIO_INTR_TRG1_1
    show_SIO_CTRL_SIO_INTR_TRG1_2
    show_SIO_CTRL_SIO_INTR_TRG1_3
    ...
    show_SIO_CTRL_SIO_INTR_ID_0
    show_SIO_CTRL_SIO_INTR_ID_1
    show_SIO_CTRL_SIO_INTR_ID_2
    show_SIO_CTRL_SIO_INTR_ID_3
}
#*********************************************************************
...
set FAN_CTRL_FAN_CFG 0x71070204
proc __show_reg_FAN_CFG {name} { show_reg $name { {duty_cycle 23 16 } { clk_cycles_10us 15 4 } { inv_pol 3 3 } { gate_ena 2 2 } { pwm_open_col_ena 1 1 } { fan_stat_cfg 0 0} } }
proc show_FAN_CTRL_FAN_CFG {} { __show_reg_FAN_CFG FAN_CTRL_FAN_CFG }

#***** Register DEVCPU_GCB:FAN_CTRL:PWM_FREQ ***************************
# Configuration of the PWM frequency.
set FAN_CTRL_PWM_FREQ 0x71070208
proc __show_reg_PWM_FREQ {name} { show_reg $name { {freq 16 0} } }
proc show_FAN_CTRL_PWM_FREQ {} { __show_reg_PWM_FREQ FAN_CTRL_PWM_FREQ }

#***** Register DEVCPU_GCB:FAN_CTRL:FAN_CNT ****************************
# TACH counter
set FAN_CTRL_FAN_CNT 0x7107020c
...
# VRAP events
set VRAP_ACCESS_STAT 0x71070228
...
proc __show_reg_DEV_INTR_POL {name} { show_reg $name { {pol 14 0} } }
...
proc __show_reg_DEV_INTR_RAW {name} { show_reg $name { {raw 14 0} } }
...
set INTR_DEV_INTR_TRG_0 0x700000cc
set INTR_DEV_INTR_TRG_1 0x700000d0
proc __show_reg_DEV_INTR_TRIGGER {name} { show_reg $name { {trg 14 0} } }
proc show_INTR_DEV_INTR_TRG_0 {} { __show_reg_DEV_INTR_TRIGGER INTR_DEV_INTR_TRG_0 }
proc show_INTR_DEV_INTR_TRG_1 {} { __show_reg_DEV_INTR_TRIGGER INTR_DEV_INTR_TRG_1 }

#***** Register ICPU_CFG:INTR:DEV_INTR_STICKY **************************
# Device interrupt sticky status
set INTR_DEV_INTR_ST 0x700000d4
proc __show_reg_DEV_INTR_STICKY {name} { show_reg $name { {st 14 0} } }
...
proc __show_reg_DEV_INTR_BYPASS {name} { show_reg $name { {bypass 14 0} } }
...
proc __show_reg_DEV_INTR_ENA {name} { show_reg $name { {ena 14 0} } }
...
set INTR_DEV_INTR_ID 0x700000e0
proc __show_reg_DEV_INTR_IDENT {name} { show_reg $name { {id 14 0} } }
...
# Timer value
set TIMER_VALUE_0 0x700000ec
set TIMER_VALUE_1 0x700000f0
set TIMER_VALUE_2 0x700000f4
...
# Timer reload value
set TIMER_RELOAD_VALUE_0 0x700000f8
set TIMER_RELOAD_VALUE_1 0x700000fc
set TIMER_RELOAD_VALUE_2 0x70000100
...
# Timer control
set TIMER_CTRL_0 0x70000104
set TIMER_CTRL_1 0x70000108
set TIMER_CTRL_2 0x7000010c
...
set MC_TERMRES_CTRL 0x70000148
...
set MC_DQS_0 0x70000150
set MC_DQS_1 0x70000154
...
set MC_DQS_AUTO_0 0x70000158
set MC_DQS_AUTO_1 0x7000015c
...
# Design for test features
set MC_MEMPHY_DFT 0x70000164
proc __show_reg_MEMPHY_DFT {name} { show_reg $name { {bypass 0 0} } }
proc show_MC_MEMPHY_DFT {} { __show_reg_MEMPHY_DFT MC_MEMPHY_DFT }

#***** Register ICPU_CFG:MEMCTRL:MEMPHY_DLLCFG0 ************************
# DLL configuration
set MC_MEMPHY_DLLCFG0_0 0x70000168
set MC_MEMPHY_DLLCFG0_1 0x7000016c
set MC_MEMPHY_DLLCFG0_2 0x70000170
...
# DLL configuration
set MC_MEMPHY_DLLCFG1_0 0x70000174
set MC_MEMPHY_DLLCFG1_1 0x70000178
set MC_MEMPHY_DLLCFG1_2 0x7000017c
...
set MC_MEMPHY_DQ_DLY_TRM_0 0x70000180
set MC_MEMPHY_DQ_DLY_TRM_1 0x70000184
...
set MC_MEMPHY_ZCAL_STAT 0x7000018c
...
set MC_MEMPHY_ZCAL_OVR 0x70000190
...
set MC_MEMPHY_ZCAL_FORCE 0x70000194
...
proc __show_reg_FDMA_GCFG {name} { show_reg $name { {frm_at_off 12 12 } { inj_rf_wm 11 7 } { xtr_rf_wm 6 3 } { xtr_avail_ext_dis 2 2 } { xtr_prio_bp_dis 1 1 } { pd_ignore 0 0} } }
...
proc __show_reg_PCIEPCS_CFG {name} { show_reg $name { {txrx_detect 22 22 } { sdetcom_perm 21 21 } { sdetcom_dis 20 20 } { beacon_force 19 19 } { rxrst_force 18 18 } { rxrst_val 17 17 } { txrst_force 16 16 } { txrst_val 15 15 } { rxsdet_xor 14 14 } { rxsdet_force 13 13 } { rxinv_ena 12 12 } { rxswap_ena 11 11 } { txswap_ena 10 10 } { idle_data_dis 9 9 } { idle_dis 8 8 } { idle 7 5 } { rxlp_force 4 4 } { txlp_force 3 3 } { wake_pol 2 2 } { wake_oe 1 1 } { beacon_dis 0 0} } }
